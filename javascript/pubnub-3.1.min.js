...
s+"}":"{"+h.join(",")+"}";c=s;return i}}window.JSON||(window.JSON={});if(typeof String.prototype.toJSON!=="function")String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()};var x=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,c,j,A={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},g;typeof JSON.stringify!=="function"&&(JSON.stringify=function(p,
...
k()})},b:function(a){b[d].d&&(i||(i=1,l()),o=a[1],setTimeout(c,10),g(a[0],function(a){e(a)}))}})}var d=a.channel,e=e||a.callback,o=0,k=a.error||n(),i=0,l=a.connect||n();if(!C)return H.push([a,e,m]);if(!d)return j("Missing Channel");if(!e)return j("Missing Callback");if(!y)return j("Missing Subscribe Key");d in b||(b[d]={});if(b[d].d)return j("Already Connected");b[d].d=1;c()},each:g,map:p,css:r,$:c,create:s,bind:d,supplant:l,head:k,search:A,attr:i,now:q,events:z,updater:x,init:u};return m}function q(){return"x"+
++M+""+ +new Date}function x(a,b){function e(){d+b>+new Date?(clearTimeout(c),c=setTimeout(e,b)):(d=+new Date,a())}var c,d=0;return e}function c(a){return document.getElementById(a)}function j(a){console.log(a)}function A(a,b){var e=[];g(a.split(/\s+/),function(a){g((b||document).getElementsByTagName(a),function(a){e.push(a)})});return e}function g(a,b){if(a&&b)if(typeof a[0]!="undefined")for(var e=0,c=a.length;e<c;)b.call(a[e],a[e],e++);else for(e in a)a.hasOwnProperty&&a.hasOwnProperty(e)&&b.call(a[e],
e,a[e])}function p(a,b){var e=[];g(a||[],function(a,c){e.push(b(a,c))});return e}function l(a,b){return a.replace(N,function(a,c){return b[c]||a})}function d(a,b,e){g(a.split(","),function(a){function c(a){if(!a)a=window.event;if(!e(a))a.cancelBubble=true,a.returnValue=false,a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation()}b.addEventListener?b.addEventListener(a,c,false):b.attachEvent?b.attachEvent("on"+a,c):b["on"+a]=c})}function k(){return A("head")[0]}function i(a,b,
c){if(c)a.setAttribute(b,c);else return a&&a.getAttribute&&a.getAttribute(b)}function r(a,b){for(var c in b)if(b.hasOwnProperty(c))try{a.style[c]=b[c]+("|width|height|top|left|".indexOf(c)>0&&typeof b[c]=="number"?"px":"")}catch(d){}}function s(a){return document.createElement(a)}function h(){return D||m()?0:q()}function f(a){return p(encodeURIComponent(a).split(""),function(a){return"-_.!~*'()".indexOf(a)<0?a:"%"+a.charCodeAt(0).toString(16).toUpperCase()}).join("")}function t(a){function b(a,b){if(!g)g=
1,a||l(b),e.onerror=null,clearTimeout(h),setTimeout(function(){a&&j();var b=c(f),e=b&&b.parentNode;e&&e.removeChild(b)},1E3)}if(D||m())return O(a);var e=s("script"),d=a.c,f=q(),g=0,h=setTimeout(function(){b(1)},E),j=a.a||n(),l=a.b||n();window[d]=function(a){b(0,a)};e[I]=I;e.onerror=function(){b(1)};e.src=a.url.join(J);i(e,"id",f);k().appendChild(e);return b}function O(a){function b(a){if(!f){f=1;clearTimeout(h);if(d)d.onerror=d.onload=null,d.abort&&d.abort(),d=null;a&&i()}}function c(){if(!g){g=1;
clearTimeout(h);try{response=JSON.parse(d.responseText)}catch(a){return b(1)}j(response)}}var d,f=0,g=0,h=setTimeout(function(){b(1)},E),i=a.a||n(),j=a.b||n();try{d=m()||window.XDomainRequest&&new XDomainRequest||new XMLHttpRequest,d.onerror=function(){b(1)},d.onload=c,d.timeout=E,d.open("GET",a.url.join(J),true),d.send()}catch(k){return b(0),D=0,t(a)}return b}function K(){clearInterval(P);C||(C=1,g(H,function(a){a[2].subscribe(a[0],a[1])}))}function m(){if(!F.get)return 0;var a={id:m.id++,send:n(),
abort:function(){a.id={}},open:function(b,c){m[a.id]=a;F.get(a.id,c)}};return a}window.console||(window.console=window.console||{});console.log||(console.log=(window.opera||{}).postError||n());var M=1,N=/{([\w\-]+)}/g,I="async",J="/",E=14E4,B=navigator.userAgent,D=B.indexOf("MSIE 6")==-1,z={list:{},unbind:function(a){z.list[a]=[]},bind:function(a,b){(z.list[a]=z.list[a]||[]).push(b)},fire:function(a,b){g(z.list[a]||[],function(a){a(b)})}},w=c("pubnub")||{},C=0,H=[],G=u({publish_key:i(w,"pub-key"),
subscribe_key:i(w,"sub-key"),ssl:i(w,"ssl")=="on",origin:i(w,"origin")}),L=!location.href.indexOf("https")?"https://dh15atwfs066y.cloudfront.net/pubnub.swf":"http://cdn.pubnub.com/pubnub.swf";r(w,{position:"absolute",top:-1E3});B.indexOf("Firefox")>0||B.indexOf("MSIE 9")>0||B.indexOf("MSIE 6")>0||(w.innerHTML="<object id=pubnubs type=application/x-shockwave-flash width=1 height=1 data="+L+"><param name=movie value="+L+" /><param name=allowscriptaccess value=always /></object>");var F=c("pubnubs")||
{},P=setInterval(function(){!("chrome"in window)&&F.get&&K()},100);d("load",window,function(){setTimeout(K,1E3)});G.rdx=function(a,b){if(!b)return m[a].onerror();m[a].responseText=unescape(b);m[a].onload()};m.id=1E3;window.jQuery&&(window.jQuery.PUBNUB=G);window.PUBNUB=G}();
