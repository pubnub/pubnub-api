...
"$1"))):c(b);b=null}},14);v.unique="x"+s();try{b.open("GET",n+p(v,n),true);b.send()}catch(w){l=0;return m(a)}return function(){j=1;b&&b.abort&&b.abort()}}var k="http://{{ORIGIN}}/",d={history:function(a,b){b=b||x();a.limit=a.limit||10;if(!a.channel)return o("Must Specify a Channel");a.channel=d.d+"/"+a.channel;m({url:k+"pubnub-history",data:a,b:function(c){b(c.messages)},c:function(c){o(c)}})},time:function(a){m({url:k+"pubnub-time",b:function(b){a(b.time)},c:function(){a(0)}})},uuid:function(a){m({url:k+
