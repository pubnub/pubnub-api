...
window.JSON||function(){function r(h){return h<10?"0"+h:h}function B(h){y.lastIndex=0;return y.test(h)?'"'+h.replace(y,function(o){var f=D[o];return typeof f==="string"?f:"\\u"+("0000"+o.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+h+'"'}function n(h,o){var f,l,j,z,x=g,k,d=o[h];if(d&&typeof d==="object"&&typeof d.toJSON==="function")d=d.toJSON(h);if(typeof q==="function")d=q.call(o,h,d);switch(typeof d){case "string":return B(d);case "number":return isFinite(d)?String(d):"null";case "boolean":case "null":return String(d);
case "object":if(!d)return"null";g+=A;k=[];if(Object.prototype.toString.apply(d)==="[object Array]"){z=d.length;for(f=0;f<z;f+=1)k[f]=n(f,d)||"null";j=k.length===0?"[]":g?"[\n"+g+k.join(",\n"+g)+"\n"+x+"]":"["+k.join(",")+"]";g=x;return j}if(q&&typeof q==="object"){z=q.length;for(f=0;f<z;f+=1){l=q[f];if(typeof l==="string")if(j=n(l,d))k.push(B(l)+(g?": ":":")+j)}}else for(l in d)if(Object.hasOwnProperty.call(d,l))if(j=n(l,d))k.push(B(l)+(g?": ":":")+j);j=k.length===0?"{}":g?"{\n"+g+k.join(",\n"+g)+
"\n"+x+"}":"{"+k.join(",")+"}";g=x;return j}}window.JSON={};if(typeof Date.prototype.toJSON!=="function"){Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+r(this.getUTCMonth()+1)+"-"+r(this.getUTCDate())+"T"+r(this.getUTCHours())+":"+r(this.getUTCMinutes())+":"+r(this.getUTCSeconds())+"Z":null};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()}}var y=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
g,A,D={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},q;if(typeof JSON.stringify!=="function")JSON.stringify=function(h,o,f){var l;A=g="";if(typeof f==="number")for(l=0;l<f;l+=1)A+=" ";else if(typeof f==="string")A=f;if((q=o)&&typeof o!=="function"&&(typeof o!=="object"||typeof o.length!=="number"))throw Error("JSON.stringify");return n("",{"":h})};if(typeof JSON.parse!=="function")JSON.parse=function(h){return eval("("+h+")")}}();
