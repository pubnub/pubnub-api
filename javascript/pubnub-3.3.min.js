...
function(){E(1)};b.onload=b.onloadend=e;b.timeout=J;var v=a.url.join(O);if(a.data){var e=[],A,v=v+"?";for(A in a.data)e.push(A+"="+a.data[A]);v+=e.join(P)}b.open("GET",v,!0);b.send()}catch(Z){E(0);I=0;a=w(a);break a}a=E}return a}var g=m("script"),v=a.callback,Q=p(),R=0,Y=setTimeout(function(){o(1)},J),u=a.fail||function(){},r=a.success||function(){},o=function(a,b){R||(R=1,a||r(b),g.onerror=null,clearTimeout(Y),setTimeout(function(){a&&u();var b=i(Q),c=b&&b.parentNode;c&&c.removeChild(b)},G))};window[v]=
function(a){o(0,a)};g[S]=S;g.onerror=function(){o(1)};g.src=a.url.join(O);if(a.data){v=[];g.src+="?";for(key in a.data)v.push(key+"="+a.data[key]);g.src+=v.join(P)}l(g,"id",Q);t().appendChild(g);return o}function K(){PUBNUB.time(q);PUBNUB.time(function(){setTimeout(function(){L||(L=1,h(T,function(a){a[2].subscribe(a[0],a[1])}))},G)})}function n(){if(!U.get)return 0;var a={id:n.id++,send:function(){},abort:function(){a.id={}},open:function(b,c){n[a.id]=a;U.get(a.id,c)}};return a}window.console||(window.console=
window.console||{});console.log||(console.log=(window.opera||{}).postError||function(){});var D,B=window.localStorage;D={get:function(a){try{return B?B.getItem(a):-1==document.cookie.indexOf(a)?null:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||null}catch(b){}},set:function(a,b){try{if(B)return B.setItem(a,b)&&0;document.cookie=a+"="+b+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(c){}}};var W=1,X=/{([\w\-]+)}/g,S="async",O="/",P="&",J=31E4,G=1E3,I=-1==navigator.userAgent.indexOf("MSIE 6"),
M,N=Math.floor(9*Math.random())+1;M=function(a){return 0<a.indexOf("pubsub")&&a.replace("pubsub","ps"+(10>++N?N:N=1))||a};var y={list:{},unbind:function(a){y.list[a]=[]},bind:function(a,b){(y.list[a]=y.list[a]||[]).push(b)},fire:function(a,b){h(y.list[a]||[],function(a){a(b)})}},r=i("pubnub")||{},L=0,T=[],V=function(a){var b={},f=a.publish_key||"",k=a.subscribe_key||"",r=a.ssl?"s":"",n=a.uuid||D.get(k+"uuid")||"",C="http"+r+"://"+(a.origin||"pubsub.pubnub.com"),B=function(){},F={history:function(a,
b){var b=a.callback||b,A=a.limit||100,d=a.channel,g=e();if(!d)return c("Missing Channel");if(!b)return c("Missing Callback");if(!k)return c("Missing Subscribe Key");w({success:function(a){b(a)},fail:function(a){c(a)},callback:g,url:[C,"history",k,z(d),g,A]})},detailedHistory:function(a,b){var b=a.callback||b,A=a.count||100,d=a.reverse||"false",g=a.channel,f=a.start,j=a.end,h={},i=e();if(!g)return c("Missing Channel");if(!b)return c("Missing Callback");if(!k)return c("Missing Subscribe Key");h.count=
A;h.reverse=d;f&&(h.start=f);j&&(h.end=j);w({callback:i,data:h,success:function(a){b(a)},fail:function(a){c(a)},url:[C,"v2","history","sub-key",k,"channel",z(g)]})},time:function(a){var b=e();w({callback:b,url:[C,"time",b],success:function(b){a(b[0])},fail:function(){a(0)}})},uuid:function(a){var b="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)});a&&a(b);return b},publish:function(a,b){var b=b||a.callback||function(){},
d=a.message,h=a.channel,g=e();if(!d)return c("Missing Message");if(!h)return c("Missing Channel");if(!f)return c("Missing Publish Key");if(!k)return c("Missing Subscribe Key");d=JSON.stringify(d);d=[C,"publish",f,k,0,z(h),g,z(d)];w({callback:g,success:function(a){b(a)},fail:function(){b([0,"Disconnected"])},url:d,data:{uuid:n}})},unsubscribe:function(a){function c(a){a in b&&(b[a].connected=0,b[a].done&&b[a].done(0))}c(a.channel);c(a.channel+"-pnpres");B(a.channel)},subscribe:function(a,d){function f(){var a=
e();b[g].connected&&(b[g].done=w({callback:a,data:{uuid:n},url:[y,"subscribe",l,z(g),a,o],fail:function(){p||(p=1,t(),i());setTimeout(f,G);F.time(function(a){if(a&&p){p=0;q()}else r()})},success:function(a){b[g].connected&&(x||(x=1,s()),p&&(p=0,q()),m=D.set(k+g,o=m&&D.get(l+g)||a[1]),h(a[0],function(b){d(b,a)}),setTimeout(f,10))}}))}function i(a){var b={uuid:n},c=e();"0"!=c&&(b.callback=c);w({callback:c,data:b,url:[y,"v2","presence","sub_key",k,"channel",z(a||g),"leave"]});return!0}var g=a.channel,
d=d||a.callback,l=a.subscribe_key||k,m=a.restore,o=0,r=a.error||function(){},s=a.connect||function(){},q=a.reconnect||function(){},t=a.disconnect||function(){},u=a.presence||function(){},p=0,x=0,y=M(C);if(!L)return T.push([a,d,F]);if(!g)return c("Missing Channel");if(!d)return c("Missing Callback");if(!k)return c("Missing Subscribe Key");g in b||(b[g]={});if(b[g].connected)return c("Already Connected");b[g].connected=1;B=i;j("beforeunload",window,i);a.presence&&F.subscribe({channel:a.channel+"-pnpres",
callback:u,restore:a.restore,disconnect:i});f()},here_now:function(a,b){var b=a.callback||b,d=a.channel,f=e(),g={},h=M(C);if(!d)return c("Missing Channel");if(!b)return c("Missing Callback");if(!k)return c("Missing Subscribe Key");"0"!=f&&(g.callback=f);w({callback:f,data:g,success:function(a){b(a)},fail:function(a){c(a)},url:[h,"v2","presence","sub_key",k,"channel",z(d)]})},xdr:w,ready:K,db:D,each:h,map:u,grep:s,css:o,$:i,create:m,bind:j,supplant:d,head:t,search:H,attr:l,now:q,unique:p,events:y,
updater:x,init:V};n||(n=F.uuid());D.set(k+"uuid",n);return F};PUBNUB=V({publish_key:l(r,"pub-key"),subscribe_key:l(r,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==l(r,"ssl"),origin:l(r,"origin"),uuid:l(r,"uuid")});o(r,{position:"absolute",top:-G});if("opera"in window||l(r,"flash"))r.innerHTML="<object id=pubnubs data=https://dh15atwfs066y.cloudfront.net/pubnub.swf><param name=movie value=https://dh15atwfs066y.cloudfront.net/pubnub.swf><param name=allowscriptaccess value=always></object>";
