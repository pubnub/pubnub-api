...
(a.d=1,a.j(a.name))});ca=X(d);setTimeout(h,J);u.time(function(a){e(function(b){a&&b.d?(b.d=0,b.k(b.name)):b.l()})})},c:function(a){if(!a)return setTimeout(h,10);e(function(a){a.e||(a.e=1,a.i(a.name))});l=!l&&B?U.get(g)||a[1]:a[1];U.set(g,a[1]);var b,c=(2<a.length?a[2]:"").split(",");b=function(){var a=c.shift()||"";return[(f[a]||{}).a||j,(a||q).split(T)[0]]};v(a[0],function(c){var d=b();if(f[d[1]].f)d[0](c,a,d[1])});setTimeout(h,10)}}))}var m=a.channel,b=(b=b||a.callback)||a.message,ja=a.error||n(),
