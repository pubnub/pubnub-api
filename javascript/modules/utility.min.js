(function(){function g(a,b){var c=0;for(b=b||"Top";a;){c+=a["offset"+b];a=a.offsetParent}return c}var e=this.localStorage,h=PUBNUB;function f(){return+new Date}h.utility={mouse:function(a){if(!a)return[[0,0]];var b=[];if(a.touches&&a.touches[0])h.a(a.touches,function(d){b.push([d.pageX,d.pageY])});else if(a.pageX)b.push([a.pageX,a.pageY]);else try{b.push([a.clientX+body.scrollLeft+doc.scrollLeft,a.clientY+body.scrollTop+doc.scrollTop])}catch(c){}return b},winfo:function(){return{height:this.innerHeight||
...
0;function i(){if(d+b>f()){clearTimeout(c);c=setTimeout(i,b)}else{d=f();a()}}return i}}})();
