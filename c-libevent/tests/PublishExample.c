...
int main() {
	...
	json_object_object_add(my_object, "some_val", json_object_new_string("Hello World"));
	struct struct_publish args1 = { .channel = "hello_world1", .message = my_object,
	...
	json_object_array_add(my_array, json_object_new_string("Sunday"));
