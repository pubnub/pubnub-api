...
(function(){function m(c){b.each(e,function(a){var d=f[a][c];if(d.connected)d.connected=false,d.socket.user_count--,b.events.fire(a+"leave",d)})}function k(c,a){var c=c||g,b=e[c];return"password"in b&&b.password&&sjcl.encrypt(b.password,JSON.stringify(a)+"")||a}function q(b,a){var b=b||g,d=e[b];if(!d.password)return a;try{return JSON.parse(sjcl.decrypt(d.password,a))}catch(f){return null}}function h(c,a,d,e,f){b.publish({channel:b.channel,message:{name:c,ns:a||g,data:k(a,d||{}),uuid:i,geo:b.location||
[0,0]},callback:function(b){if(b[0])return(f||function(){})(b);var l=(e||500)*2;setTimeout(function(){h(c,a,d,l,f)},l>5500?5500:l)}})}function n(c){c=c||function(){};navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(a){b.location=[a.coords.latitude,a.coords.longitude];c(b.location)})||c([0,0])}function o(c){c!==g&&!(g in e)&&o(g);return e[c]={namespace:c,users:f[c]={},user_count:1,get_user_list:function(){return e[c].users},get_user_count:function(){return e[c].user_count},
emit:function(b,d,e){h(b,c,d,0,e)},send:function(b,d){h("message",c,b,0,d)},on:function(a,d){typeof a==="string"?b.events.bind(c+a,d):typeof a==="object"&&b.each(a,function(a){b.events.bind(c+a,d)})},disconnect:function(){delete e[c]}}}(function(){var b=window.localStorage;PUBNUB.db={get:function(a){return b?b.getItem(a):document.cookie.indexOf(a)==-1?null:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||null},set:function(a,d){if(b)return b.setItem(a,d);document.cookie=a+"="+d+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}}})();
var b=PUBNUB,g="standard",i=PUBNUB.db.get("uuid")||b.uuid(function(b){PUBNUB.db.set("uuid",i=b)}),e={},f={},p=window.io={connected:false,connect:function(c,a){var d=(c+"////").split("/"),a=a||{},k=a.user||{},r=d[2],j=o(d[3]||g);j.password="sjcl"in window&&a.password;if(p.connected)return j;p.connected=true;a.geo&&setInterval(n,15E3)&&n();a.origin=r;b=b.init(a);b.disconnected=0;b.channel=a.channel||g;b.subscribe({channel:b.channel,disconnect:function(){if(!b.disconnected)b.disconnected=1,b.each(e,
function(a){b.events.fire(a+"disconnect",{})})},reconnect:function(){b.disconnected=0},connect:function(){b.disconnected=0;b.each(e,function(a){b.events.fire(a+"connect",{})})},callback:function(a){b.disconnected&&b.each(e,function(a){b.events.fire(a+"reconnect",{})});b.disconnected=0;var c=q(a.ns,a.data);a.ns in e&&c&&b.events.fire(a.ns+a.name,c);a.uuid&&a.uuid!==i&&(a.name==="ping"&&b.each(c.nss,function(d){f[d]=f[d]||{};var e=f[d][a.uuid]=f[d][a.uuid]||{geo:a.geo||[0,0],uuid:a.uuid,last:+new Date,
socket:j,namespace:d,connected:false,slot:j.user_count++};e.last=+new Date;e.data=c.cuser;if(!e.connected)e.connected=true,b.events.fire(d+"join",e)}),a.name==="user-disconnect"&&m(a.uuid))}});b.tcpKeepAlive=setInterval(b.updater(function(){var a=b.map(e,function(a){return a});h("ping",g,{nss:a,cuser:k})},2500),500);return j}};setInterval(function(){b.disconnected||b.each(f,function(c){b.each(f[c],function(a){var b=f[c][a];+new Date-b.last<5500||a===i||m(b.uuid)})})},1E3);typeof window!=="undefined"&&
b.bind("beforeunload",window,function(){h("user-disconnect","",i);return true})})();
