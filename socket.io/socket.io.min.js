...
window.JSON&&window.JSON.stringify||function(){function v(c){k.lastIndex=0;return k.test(c)?'"'+c.replace(k,function(c){var e=g[c];return"string"===typeof e?e:"\\u"+("0000"+c.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+c+'"'}function t(c,g){var e,h,o,n,k=i,l,f=g[c];f&&"object"===typeof f&&"function"===typeof f.toJSON&&(f=f.toJSON(c));"function"===typeof m&&(f=m.call(g,c,f));switch(typeof f){case "string":return v(f);case "number":return isFinite(f)?""+f:"null";case "boolean":case "null":return""+
f;case "object":if(!f)return"null";i+=p;l=[];if("[object Array]"===Object.prototype.toString.apply(f)){n=f.length;for(e=0;e<n;e+=1)l[e]=t(e,f)||"null";o=0===l.length?"[]":i?"[\n"+i+l.join(",\n"+i)+"\n"+k+"]":"["+l.join(",")+"]";i=k;return o}if(m&&"object"===typeof m){n=m.length;for(e=0;e<n;e+=1)h=m[e],"string"===typeof h&&(o=t(h,f))&&l.push(v(h)+(i?": ":":")+o)}else for(h in f)Object.hasOwnProperty.call(f,h)&&(o=t(h,f))&&l.push(v(h)+(i?": ":":")+o);o=0===l.length?"{}":i?"{\n"+i+l.join(",\n"+i)+"\n"+
...
window.PUBNUB||function(){function v(a){var b={},d=a.publish_key||"demo",s=a.subscribe_key||"demo",j=a.ssl?"s":"",z="http"+j+"://"+(a.origin||"pubsub.pubnub.com"),q={history:function(a,b){var b=a.callback||b,d=a.limit||100,c=a.channel,e=f();if(!c)return g("Missing Channel");if(!b)return g("Missing Callback");w({c:e,url:[z,"history",s,A(c),e,d],b:function(a){b(a)},a:function(a){g(a)}})},time:function(a){var b=f();w({c:b,url:[z,"time",b],b:function(b){a(b[0])},a:function(){a(0)}})},uuid:function(a){var b=
f();w({c:b,url:["http"+j+"://pubnub-prod.appspot.com/uuid?callback="+b],b:function(b){a(b[0])},a:function(){a(0)}})},publish:function(a,b){var b=b||a.callback||r(),c=a.message,e=a.channel,j=f();if(!c)return g("Missing Message");if(!e)return g("Missing Channel");if(!d)return g("Missing Publish Key");c=JSON.stringify(c);c=[z,"publish",d,s,0,A(e),j,A(c)];if(1800<c.join().length)return g("Message Too Big");w({c:j,b:function(a){b(a)},a:function(){b([0,"Disconnected"])},url:c})},unsubscribe:function(a){a=
a.channel;a in b&&(b[a].d=0,b[a].e&&b[a].e(0))},subscribe:function(a,d){function e(){var a=f();b[j].d&&(b[j].e=w({c:a,url:[t,"subscribe",s,A(j),a,i],a:function(){m||(m=1,o());setTimeout(e,x);q.time(function(a){a||k()})},b:function(a){b[j].d&&(p||(p=1,l()),m&&(m=0,n()),h=B.set(s+j,i=h&&B.get(s+j)||a[1]),c(a[0],function(b){d(b,a)}),setTimeout(e,10))}}))}var j=a.channel,d=d||a.callback,h=a.restore,i=0,k=a.error||r(),l=a.connect||r(),n=a.reconnect||r(),o=a.disconnect||r(),m=0,p=0,t=M(z);if(!C)return H.push([a,
d,q]);if(!j)return g("Missing Channel");if(!d)return g("Missing Callback");if(!s)return g("Missing Subscribe Key");j in b||(b[j]={});if(b[j].d)return g("Already Connected");b[j].d=1;e()},db:B,each:c,map:F,css:G,$:p,create:l,bind:h,supplant:e,head:o,search:m,attr:n,now:k,unique:t,events:y,updater:i,init:v};return q}function t(){return"x"+ ++N+""+ +new Date}function k(){return+new Date}function i(a,b){function d(){c+b>k()?(clearTimeout(s),s=setTimeout(d,b)):(c=k(),a())}var s,c=0;return d}function p(a){return document.getElementById(a)}
function g(a){console.log(a)}function m(a,b){var d=[];c(a.split(/\s+/),function(a){c((b||document).getElementsByTagName(a),function(a){d.push(a)})});return d}function c(a,b){if(a&&b)if("undefined"!=typeof a[0])for(var d=0,s=a.length;d<s;)b.call(a[d],a[d],d++);else for(d in a)a.hasOwnProperty&&a.hasOwnProperty(d)&&b.call(a[d],d,a[d])}function F(a,b){var d=[];c(a||[],function(a,c){d.push(b(a,c))});return d}function e(a,b){return a.replace(O,function(a,c){return b[c]||a})}function h(a,b,d){c(a.split(","),
function(a){function c(a){a||(a=window.event);d(a)||(a.cancelBubble=!0,a.returnValue=!1,a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation())}b.addEventListener?b.addEventListener(a,c,!1):b.attachEvent?b.attachEvent("on"+a,c):b["on"+a]=c})}function o(){return m("head")[0]}function n(a,b,d){if(d)a.setAttribute(b,d);else return a&&a.getAttribute&&a.getAttribute(b)}function G(a,b){for(var d in b)if(b.hasOwnProperty(d))try{a.style[d]=b[d]+(0<"|width|height|top|left|".indexOf(d)&&
"number"==typeof b[d]?"px":"")}catch(c){}}function l(a){return document.createElement(a)}function f(){return D||q()?0:t()}function A(a){return F(encodeURIComponent(a).split(""),function(a){return 0>"-_.!~*'()".indexOf(a)?a:"%"+a.charCodeAt(0).toString(16).toUpperCase()}).join("")}function w(a){function b(a,b){f||(f=1,a||i(b),d.onerror=null,clearTimeout(g),setTimeout(function(){a&&h();var b=p(e),d=b&&b.parentNode;d&&d.removeChild(b)},x))}if(D||q())return P(a);var d=l("script"),c=a.c,e=t(),f=0,g=setTimeout(function(){b(1)},
E),h=a.a||r(),i=a.b||r();window[c]=function(a){b(0,a)};d[I]=I;d.onerror=function(){b(1)};d.src=a.url.join(J);n(d,"id",e);o().appendChild(d);return b}function P(a){function b(a){e||(e=1,clearTimeout(g),c&&(c.onerror=c.onload=null,c.abort&&c.abort(),c=null),a&&h())}function d(){if(!f){f=1;clearTimeout(g);try{response=JSON.parse(c.responseText)}catch(a){return b(1)}i(response)}}var c,e=0,f=0,g=setTimeout(function(){b(1)},E),h=a.a||r(),i=a.b||r();try{c=q()||window.XDomainRequest&&new XDomainRequest||
new XMLHttpRequest,c.onerror=c.onabort=function(){b(1)},c.onload=c.onloadend=d,c.timeout=E,c.open("GET",a.url.join(J),!0),c.send()}catch(k){return b(0),D=0,w(a)}return b}function K(){PUBNUB.time(k);PUBNUB.time(function(){setTimeout(function(){C||(C=1,c(H,function(a){a[2].subscribe(a[0],a[1])}))},x)})}function q(){if(!L.get)return 0;var a={id:q.id++,send:r(),abort:function(){a.id={}},open:function(b,c){q[a.id]=a;L.get(a.id,c)}};return a}window.console||(window.console=window.console||{});console.log||
(console.log=(window.opera||{}).postError||r());var B=function(){var a=window.localStorage;return{get:function(b){try{return a?a.getItem(b):-1==document.cookie.indexOf(b)?null:((document.cookie||"").match(RegExp(b+"=([^;]+)"))||[])[1]||null}catch(c){}},set:function(b,c){try{if(a)return a.setItem(b,c)&&0;document.cookie=b+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(e){}}}}(),N=1,O=/{([\w\-]+)}/g,I="async",J="/",E=14E4,x=1E3,D=-1==navigator.userAgent.indexOf("MSIE 6"),M=function(){var a=
Math.floor(9*Math.random())+1;return function(b){return 0<b.indexOf("pubsub")&&b.replace("pubsub","ps"+(10>++a?a:a=1))||b}}(),y={list:{},unbind:function(a){y.list[a]=[]},bind:function(a,b){(y.list[a]=y.list[a]||[]).push(b)},fire:function(a,b){c(y.list[a]||[],function(a){a(b)})}},u=p("pubnub")||{},C=0,H=[];PUBNUB=v({publish_key:n(u,"pub-key"),subscribe_key:n(u,"sub-key"),ssl:"on"==n(u,"ssl"),origin:n(u,"origin")});G(u,{position:"absolute",top:-x});if("opera"in window||n(u,"flash"))u.innerHTML="<object id=pubnubs data=https://dh15atwfs066y.cloudfront.net/pubnub.swf><param name=movie value=https://dh15atwfs066y.cloudfront.net/pubnub.swf><param name=allowscriptaccess value=always></object>";
var L=p("pubnubs")||{};h("load",window,function(){setTimeout(K,0)});PUBNUB.rdx=function(a,b){if(!b)return q[a].onerror();q[a].responseText=unescape(b);q[a].onload()};q.id=x;window.jQuery&&(window.jQuery.PUBNUB=PUBNUB);"undefined"!==typeof module&&(module.f=PUBNUB)&&K()}();
})();
(function(){
...
(function(){function m(c){b.each(e,function(a){var d=f[a][c];d.connected&&(d.connected=!1,d.socket.user_count--,b.events.fire(a+"leave",d))})}function k(c,a){var c=c||g,b=e[c];return"password"in b&&b.password&&sjcl.encrypt(b.password,JSON.stringify(a)+"")||a}function q(b,a){var b=b||g,d=e[b];if(!d.password)return a;try{return JSON.parse(sjcl.decrypt(d.password,a))}catch(f){return null}}function h(c,a,d,e,f){b.publish({channel:b.channel,message:{name:c,ns:a||g,data:k(a,d||{}),uuid:i,geo:b.location||
[0,0]},callback:function(b){if(b[0])return(f||function(){})(b);var l=2*(e||500);setTimeout(function(){h(c,a,d,l,f)},5500<l?5500:l)}})}function n(c){c=c||function(){};navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(a){b.location=[a.coords.latitude,a.coords.longitude];c(b.location)})||c([0,0])}function o(c){c!==g&&!(g in e)&&o(g);return e[c]={namespace:c,users:f[c]={},user_count:1,get_user_list:function(){return e[c].users},get_user_count:function(){return e[c].user_count},
emit:function(b,d,e){h(b,c,d,0,e)},send:function(b,d){h("message",c,b,0,d)},on:function(a,d){"string"===typeof a?b.events.bind(c+a,d):"object"===typeof a&&b.each(a,function(a){b.events.bind(c+a,d)})},disconnect:function(){delete e[c]}}}(function(){var b=window.localStorage;PUBNUB.db={get:function(a){return b?b.getItem(a):-1==document.cookie.indexOf(a)?null:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||null},set:function(a,d){if(b)return b.setItem(a,d);document.cookie=a+"="+d+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}}})();
var b=PUBNUB,g="standard",i=PUBNUB.db.get("uuid")||b.uuid(function(b){PUBNUB.db.set("uuid",i=b)}),e={},f={},p=window.io={connected:!1,connect:function(c,a){var d=(c+"////").split("/"),a=a||{},k=a.user||{},r=d[2],j=o(d[3]||g);j.password="sjcl"in window&&a.password;if(p.connected)return j;p.connected=!0;a.geo&&setInterval(n,15E3)&&n();a.origin=r;b=b.init(a);b.disconnected=0;b.channel=a.channel||g;b.subscribe({channel:b.channel,disconnect:function(){b.disconnected||(b.disconnected=1,b.each(e,function(a){b.events.fire(a+
"disconnect",{})}))},reconnect:function(){b.disconnected=0},connect:function(){b.disconnected=0;b.each(e,function(a){b.events.fire(a+"connect",{})})},callback:function(a){b.disconnected&&b.each(e,function(a){b.events.fire(a+"reconnect",{})});b.disconnected=0;var c=q(a.ns,a.data);a.ns in e&&c&&b.events.fire(a.ns+a.name,c);a.uuid&&a.uuid!==i&&("ping"===a.name&&b.each(c.nss,function(d){f[d]=f[d]||{};var e=f[d][a.uuid]=f[d][a.uuid]||{geo:a.geo||[0,0],uuid:a.uuid,last:+new Date,socket:j,namespace:d,connected:!1,
slot:j.user_count++};e.last=+new Date;e.data=c.cuser;e.connected||(e.connected=!0,b.events.fire(d+"join",e))}),"user-disconnect"===a.name&&m(a.uuid))}});b.tcpKeepAlive=setInterval(b.updater(function(){var a=b.map(e,function(a){return a});h("ping",g,{nss:a,cuser:k})},2500),500);return j}};setInterval(function(){b.disconnected||b.each(f,function(c){b.each(f[c],function(a){var b=f[c][a];5500>+new Date-b.last||a===i||m(b.uuid)})})},1E3);"undefined"!==typeof window&&b.bind("beforeunload",window,function(){h("user-disconnect",
"",i);return!0})})();
