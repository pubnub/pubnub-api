...
(function(){function l(a){if(a.c)a.c=false,a.f.user_count--,b.events.fire(a.e+"leave",a)}function k(a,b){var a=a||g,c=f[a];return"password"in c&&c.password&&sjcl.encrypt(c.password,JSON.stringify(b)+"")||b}function p(a,b){var a=a||g,c=f[a];if(!c.password)return b;try{return JSON.parse(sjcl.decrypt(c.password,b))}catch(e){return null}}function j(a,d,c,e,f){b.publish({channel:b.b,message:{name:a,ns:d||g,data:k(d,c||{}),uuid:i,geo:b.location||[0,0]},callback:function(b){if(b[0])return(f||function(){})(b);
b=(e||500)*2;setTimeout(a,c,b>1E4&&1E4||b)}})}function m(a){a=a||function(){};navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(d){b.location=[d.coords.latitude,d.coords.longitude];a(b.location)})||a([0,0])}function n(a){a!==g&&!(g in f)&&n(g);return f[a]={users:e[a]={},user_count:1,get_user_list:function(){return f[a].users},get_user_count:function(){return f[a].user_count},emit:function(b,c,e){j(b,a,c,0,e)},send:function(b,c){j("message",a,b,0,c)},on:function(d,
c){b.events.bind(a+d,c)},disconnect:function(){delete f[a]}}}"PUBNUB"in window||console.error("Missing PubNub JS Include!");var b=PUBNUB,g="standard",i=b.uuid(function(b){i=b}),f={},e={},o=window.io={connected:false,connect:function(a,d){var c=(a+"////").split("/"),d=d||{},k=c[2],h=n(c[3]||g);h.password="sjcl"in window&&d.password;if(o.connected)return h;o.connected=true;d.geo&&setInterval(m,15E3)&&m();d.origin=k;b=b.init(d);b.a=0;b.b=d.channel||g;b.subscribe({channel:b.b,error:function(){if(!b.a)b.a=
1,b.each(f,function(a){b.events.fire(a+"disconnect",{})})},connect:function(){b.a=0;b.each(f,function(a){b.events.fire(a+"connect",{})})},callback:function(a){b.a&&b.each(a.ns,function(a){b.events.fire(a+"reconnect",{})});b.a=0;a.uuid&&a.uuid!==i&&(e[a.ns]=e[a.ns]||{});e[a.ns][a.uuid]=e[a.ns][a.uuid]||function(){setTimeout(function(){h.emit("join",{geo:a.geo||[0,0],uuid:a.uuid,last:+new Date,namespace:a.ns,connected:true,slot:h.user_count++})},10);return{geo:a.geo||[0,0],uuid:a.uuid,last:+new Date,
socket:h,namespace:a.ns,connected:true,slot:h.user_count++}}();a.name==="user-disconnect"&&l(e[a.ns][a.uuid]);if(a.name==="ping")e[a.ns][a.uuid].d=+new Date;if(a.ns in f){var c=p(a.ns,a.data);c&&b.events.fire(a.ns+a.name,c)}}});b.g=setInterval(function(){j("ping")},2500);return h}};setInterval(function(){b.a||b.each(e,function(a){b.each(e[a],function(b){var c=e[a][b];+new Date-c.d<5E3||b===i||l(c)})})},1E3);typeof window!=="undefined"&&b.bind("beforeunload",window,function(){j("user-disconnect","",
i);return true})})();
