...
case "object":if(!e)return"null";i+=t;m=[];if(Object.prototype.toString.apply(e)==="[object Array]"){k=e.length;for(g=0;g<k;g+=1)m[g]=u(g,e)||"null";n=m.length===0?"[]":i?"[\n"+i+m.join(",\n"+i)+"\n"+l+"]":"["+m.join(",")+"]";i=l;return n}if(o&&typeof o==="object"){k=o.length;for(g=0;g<k;g+=1)h=o[g],typeof h==="string"&&(n=u(h,e))&&m.push(y(h)+(i?": ":":")+n)}else for(h in e)Object.hasOwnProperty.call(e,h)&&(n=u(h,e))&&m.push(y(h)+(i?": ":":")+n);n=m.length===0?"{}":i?"{\n"+i+m.join(",\n"+i)+"\n"+
l+"}":"{"+m.join(",")+"}";i=l;return n}}window.JSON||(window.JSON={});if(typeof String.prototype.toJSON!=="function")String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()};var l=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,i,t,f={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},o;typeof JSON.stringify!=="function"&&(JSON.stringify=function(c,
f,g){var h;t=i="";if(typeof g==="number")for(h=0;h<g;h+=1)t+=" ";else typeof g==="string"&&(t=g);if((o=f)&&typeof f!=="function"&&(typeof f!=="object"||typeof f.length!=="number"))throw Error("JSON.stringify");return u("",{"":c})});typeof JSON.parse!=="function"&&(JSON.parse=function(c){return eval("("+c+")")})}();
window.PUBNUB||function(){function y(a){var b={},d=a.publish_key||"demo",r=a.subscribe_key||"demo",s=a.ssl?"s":"",v="http"+s+"://"+(a.origin||"pubsub.pubnub.com"),p={history:function(a,b){var b=a.callback||b,d=a.limit||100,j=a.channel,c=e();if(!j)return f("Missing Channel");if(!b)return f("Missing Callback");w({c:c,url:[v,"history",r,z(j),c,d],b:function(a){b(a)},a:function(a){f(a)}})},time:function(a){var b=e();w({c:b,url:[v,"time",b],b:function(b){a(b[0])},a:function(){a(0)}})},uuid:function(a){var b=
e();w({c:b,url:["http"+s+"://pubnub-prod.appspot.com/uuid?callback="+b],b:function(b){a(b[0])},a:function(){a(0)}})},analytics:function(a){var b=e(),c=a.limit||100,j=a.ago||0,f=a.duration||100,v=a.callback;w({c:b,b:function(a){v(a)},a:function(){v(0)},url:[["http"+s+"://pubnub-prod.appspot.com/analytics-channel?callback="+b,"sub-key="+r,"pub-key="+d,"channel="+z(a.channel||""),"limit="+c,"ago="+j,"duration="+f].join("&")]})},publish:function(a,b){var b=b||a.callback||q(),c=a.message,j=a.channel,s=
e();if(!c)return f("Missing Message");if(!j)return f("Missing Channel");if(!d)return f("Missing Publish Key");c=JSON.stringify(c);c=[v,"publish",d,r,0,z(j),s,z(c)];if(c.join().length>1800)return f("Message Too Big");w({c:s,b:function(a){b(a)},a:function(){b([0,"Disconnected"])},url:c})},unsubscribe:function(a){a=a.channel;if(a in b)b[a].d=0,b[a].e&&b[a].e(0)},subscribe:function(a,d){function s(){var a=e();if(b[j].d)b[j].e=w({c:a,url:[o,"subscribe",r,z(j),a,h],a:function(){k||(k=1,m());setTimeout(s,
A)},b:function(a){b[j].d&&(n||(n=1,i()),k&&(k=0,l()),g=C.set(r+j,h=g&&C.get(r+j)||a[1]),c(a[0],function(b){d(b,a)}),setTimeout(s,10))}})}var j=a.channel,d=d||a.callback,g=a.restore,h=0,i=a.connect||q(),l=a.reconnect||q(),m=a.error||a.disconnect||q(),k=0,n=0,o=N(v);if(!D)return I.push([a,d,p]);if(!j)return f("Missing Channel");if(!d)return f("Missing Callback");if(!r)return f("Missing Subscribe Key");j in b||(b[j]={});if(b[j].d)return f("Already Connected");b[j].d=1;s()},db:C,each:c,map:G,css:H,$:t,
create:m,bind:h,supplant:g,head:n,search:o,attr:k,now:l,unique:u,events:B,updater:i,init:y};return p}function u(){return"x"+ ++O+""+ +new Date}function l(){return+new Date}function i(a,b){function d(){c+b>l()?(clearTimeout(r),r=setTimeout(d,b)):(c=l(),a())}var r,c=0;return d}function t(a){return document.getElementById(a)}function f(a){console.log(a)}function o(a,b){var d=[];c(a.split(/\s+/),function(a){c((b||document).getElementsByTagName(a),function(a){d.push(a)})});return d}function c(a,b){if(a&&
b)if(typeof a[0]!="undefined")for(var d=0,c=a.length;d<c;)b.call(a[d],a[d],d++);else for(d in a)a.hasOwnProperty&&a.hasOwnProperty(d)&&b.call(a[d],d,a[d])}function G(a,b){var d=[];c(a||[],function(a,c){d.push(b(a,c))});return d}function g(a,b){return a.replace(P,function(a,c){return b[c]||a})}function h(a,b,d){c(a.split(","),function(a){function c(a){if(!a)a=window.event;if(!d(a))a.cancelBubble=true,a.returnValue=false,a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation()}b.addEventListener?
b.addEventListener(a,c,false):b.attachEvent?b.attachEvent("on"+a,c):b["on"+a]=c})}function n(){return o("head")[0]}function k(a,b,d){if(d)a.setAttribute(b,d);else return a&&a.getAttribute&&a.getAttribute(b)}function H(a,b){for(var d in b)if(b.hasOwnProperty(d))try{a.style[d]=b[d]+("|width|height|top|left|".indexOf(d)>0&&typeof b[d]=="number"?"px":"")}catch(c){}}function m(a){return document.createElement(a)}function e(){return E||p()?0:u()}function z(a){return G(encodeURIComponent(a).split(""),function(a){return"-_.!~*'()".indexOf(a)<
0?a:"%"+a.charCodeAt(0).toString(16).toUpperCase()}).join("")}function w(a){function b(a,b){if(!f)f=1,a||i(b),d.onerror=null,clearTimeout(g),setTimeout(function(){a&&h();var b=t(e),d=b&&b.parentNode;d&&d.removeChild(b)},A)}if(E||p())return Q(a);var d=m("script"),c=a.c,e=u(),f=0,g=setTimeout(function(){b(1)},F),h=a.a||q(),i=a.b||q();window[c]=function(a){b(0,a)};d[J]=J;d.onerror=function(){b(1)};d.src=a.url.join(K);k(d,"id",e);n().appendChild(d);return b}function Q(a){function b(a){if(!e){e=1;clearTimeout(g);
if(c)c.onerror=c.onload=null,c.abort&&c.abort(),c=null;a&&h()}}function d(){if(!f){f=1;clearTimeout(g);try{response=JSON.parse(c.responseText)}catch(a){return b(1)}i(response)}}var c,e=0,f=0,g=setTimeout(function(){b(1)},F),h=a.a||q(),i=a.b||q();try{c=p()||window.XDomainRequest&&new XDomainRequest||new XMLHttpRequest,c.onerror=c.onabort=function(){b(1)},c.onload=c.onloadend=d,c.timeout=F,c.open("GET",a.url.join(K),true),c.send()}catch(k){return b(0),E=0,w(a)}return b}function L(){PUBNUB.time(l);PUBNUB.time(function(){setTimeout(function(){D||
(D=1,c(I,function(a){a[2].subscribe(a[0],a[1])}))},A)})}function p(){if(!M.get)return 0;var a={id:p.id++,send:q(),abort:function(){a.id={}},open:function(b,c){p[a.id]=a;M.get(a.id,c)}};return a}window.console||(window.console=window.console||{});console.log||(console.log=(window.opera||{}).postError||q());var C=function(){var a=window.localStorage;return{get:function(b){return a?a.getItem(b):document.cookie.indexOf(b)==-1?null:((document.cookie||"").match(RegExp(b+"=([^;]+)"))||[])[1]||null},set:function(b,
...
x=t("pubnub")||{},D=0,I=[];PUBNUB=y({publish_key:k(x,"pub-key"),subscribe_key:k(x,"sub-key"),ssl:k(x,"ssl")=="on",origin:k(x,"origin")});H(x,{position:"absolute",top:-A});if("opera"in window||k(x,"flash"))x.innerHTML="<object id=pubnubs type=application/x-shockwave-flash width=1 height=1 data=https://dh15atwfs066y.cloudfront.net/pubnub.swf><param name=movie value=https://dh15atwfs066y.cloudfront.net/pubnub.swf /><param name=allowscriptaccess value=always /></object>";var M=t("pubnubs")||{};h("load",
window,function(){setTimeout(L,0)});PUBNUB.rdx=function(a,b){if(!b)return p[a].onerror();p[a].responseText=unescape(b);p[a].onload()};p.id=A;window.jQuery&&(window.jQuery.PUBNUB=PUBNUB);typeof module!=="undefined"&&(module.f=PUBNUB)&&L()}();
(function(){
...
(function(){function l(c){b.each(e,function(a){var d=f[a][c];if(d.connected)d.connected=false,d.socket.user_count--,b.events.fire(a+"leave",d)})}function k(c,a){var c=c||g,b=e[c];return"password"in b&&b.password&&sjcl.encrypt(b.password,JSON.stringify(a)+"")||a}function p(b,a){var b=b||g,d=e[b];if(!d.password)return a;try{return JSON.parse(sjcl.decrypt(d.password,a))}catch(f){return null}}function h(c,a,d,e,f){b.publish({channel:b.channel,message:{name:c,ns:a||g,data:k(a,d||{}),uuid:j,geo:b.location||
[0,0]},callback:function(b){if(b[0])return(f||function(){})(b);var g=(e||500)*2;setTimeout(function(){h(c,a,d,g,f)},g>5500?5500:g)}})}function m(c){c=c||function(){};navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(a){b.location=[a.coords.latitude,a.coords.longitude];c(b.location)})||c([0,0])}function n(c){c!==g&&!(g in e)&&n(g);return e[c]={namespace:c,users:f[c]={},user_count:1,get_user_list:function(){return e[c].users},get_user_count:function(){return e[c].user_count},
emit:function(b,d,e){h(b,c,d,0,e)},send:function(b,d){h("message",c,b,0,d)},on:function(a,d){typeof a==="string"?b.events.bind(c+a,d):typeof a==="object"&&b.each(a,function(a){b.events.bind(c+a,d)})},disconnect:function(){delete e[c]}}}"PUBNUB"in window||console.error("Missing PubNub JS Include!");(function(){var b=window.localStorage;PUBNUB.db={get:function(a){return b?b.getItem(a):document.cookie.indexOf(a)==-1?null:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||null},set:function(a,
d){if(b)return b.setItem(a,d);document.cookie=a+"="+d+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}}})();var b=PUBNUB,g="standard",j=PUBNUB.db.get("uuid")||b.uuid(function(b){PUBNUB.db.set("uuid",j=b)}),e={},f={},o=window.io={connected:false,connect:function(c,a){var d=(c+"////").split("/"),a=a||{},k=d[2],i=n(d[3]||g);i.password="sjcl"in window&&a.password;if(o.connected)return i;o.connected=true;a.geo&&setInterval(m,15E3)&&m();a.origin=k;b=b.init(a);b.disconnected=0;b.channel=a.channel||g;b.subscribe({channel:b.channel,
error:function(){if(!b.disconnected)b.disconnected=1,b.each(e,function(a){b.events.fire(a+"disconnect",{})})},connect:function(){b.disconnected=0;b.each(e,function(a){b.events.fire(a+"connect",{})})},callback:function(a){b.disconnected&&b.each(e,function(a){b.events.fire(a+"reconnect",{})});b.disconnected=0;var c=p(a.ns,a.data);a.ns in e&&c&&b.events.fire(a.ns+a.name,c);a.uuid&&a.uuid!==j&&(a.name==="ping"&&b.each(c,function(c){f[c]=f[c]||{};var d=f[c][a.uuid]=f[c][a.uuid]||{geo:a.geo||[0,0],uuid:a.uuid,
last:+new Date,socket:i,namespace:c,connected:false,slot:i.user_count++};d.last=+new Date;if(!d.connected)d.connected=true,b.events.fire(c+"join",d)}),a.name==="user-disconnect"&&l(a.uuid))}});b.tcpKeepAlive=setInterval(b.updater(function(){var a=b.map(e,function(a){return a});h("ping",g,a)},2500),500);return i}};setInterval(function(){b.disconnected||b.each(f,function(c){b.each(f[c],function(a){var b=f[c][a];+new Date-b.last<5500||a===j||l(b.uuid)})})},1E3);typeof window!=="undefined"&&b.bind("beforeunload",
window,function(){h("user-disconnect","",j);return true})})();
