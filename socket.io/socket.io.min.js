...
var b=PUBNUB,g="standard",i=PUBNUB.db.get("uuid")||b.uuid(function(b){PUBNUB.db.set("uuid",i=b)}),e={},f={},o=window.io={connected:!1,connect:function(c,a){var d=(c+"////").split("/"),a=a||{},k=a.user||{},q="presence"in a?a.presence:!0,r=d[2],j=n(d[3]||g);j.password="sjcl"in window&&a.password;if(o.connected)return j;o.connected=!0;a.geo&&setInterval(m,15E3)&&m();a.origin=r;b=b.init(a);b.disconnected=0;b.channel=a.channel||g;b.subscribe({channel:b.channel,disconnect:function(){b.disconnected||(b.disconnected=
1,b.each(e,function(a){b.events.fire(a+"disconnect",{})}))},reconnect:function(){b.disconnected=0},connect:function(){b.disconnected=0;b.each(e,function(a){b.events.fire(a+"connect",{})})},callback:function(a){b.disconnected&&b.each(e,function(a){b.events.fire(a+"reconnect",{})});b.disconnected=0;var c=p(a.ns,a.data);a.ns in e&&c&&b.events.fire(a.ns+a.name,c);a.uuid&&a.uuid!==i&&("ping"===a.name&&b.each(c.nss,function(d){f[d]=f[d]||{};var e=f[d][a.uuid]=f[d][a.uuid]||{geo:a.geo||[0,0],uuid:a.uuid,
last:+new Date,socket:j,namespace:d,connected:!1,slot:j.user_count++};e.last=+new Date;e.data=c.cuser;e.connected||(e.connected=!0,b.events.fire(d+"join",e))}),"user-disconnect"===a.name&&l(a.uuid))}});q&&(b.tcpKeepAlive=setInterval(b.updater(function(){var a=b.map(e,function(a){return a});h("ping",g,{nss:a,cuser:k})},2500),500));return j}};setInterval(function(){b.disconnected||b.each(f,function(c){b.each(f[c],function(a){var b=f[c][a];5500>+new Date-b.last||a===i||l(b.uuid)})})},1E3);"undefined"!==
typeof window&&b.bind("beforeunload",window,function(){h("user-disconnect","",i);return!0})})();
