(function(){
    ...
    ,   io         = window.io = {
        ...
        connect   : function( host, setup ) {
            ...
            console.log("!!!!!!!!!!!","p.subscribe", socket.channel);
            p.subscribe({
                channel    : channel,
                disconnect : dropped,
    ...
    function send( event, namespace, data, wait, cb ) {
        ...
        console.log("!!!!!!!!!!!","p.publish", socket.channel);
        p.publish({
    ...
    function history( namespace, args, callback ) {
        ...
        console.log("!!!!!!!!!!!","p.history", socket.channel);
    ...
    function here_now( namespace, callback ) {
        var socket = get_socket(namespace);
        console.log("!!!!!!!!!!!","p.here_now", socket.channel);
    ...
    function get_socket(namespace) {
        ...
        ,   socket    = namespaces[namespace] || (function(){
                return namespaces[namespace] = {
                    ...
                    disconnect : function() {
                        console.log("!!!!!!!!!!!","p.unsubscribe", socket.channel);
