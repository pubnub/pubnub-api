...
"undefined"!==typeof module&&(module.exports=PUBNUB)&&S()};
})();
(function(){
...
(function(){function p(b){c.each(d,function(a){if(a in h&&b in h[a]){var e=h[a][b];e.connected&&(e.connected=!1,e.socket.user_count--,c.events.fire(a+"leave",e))}})}function n(b,a){var e=i(b);return"password"in e&&e.password&&sjcl.encrypt(e.password,JSON.stringify(a)+"")||a}function l(b,a,e,f,d){var k=i(a);c.publish({channel:k.channel,message:{name:b,ns:a,data:n(a,e||{}),uuid:m,geo:k.location||[0,0]},callback:function(c){if(c[0])return(d||function(){})(c);var j=2*(f||500);setTimeout(function(){l(b,
a,e,j,d)},5500<j?5500:j)}})}function q(b){b=b||function(){};navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(a){socket.location=[a.coords.latitude,a.coords.longitude];b(socket.location)})||b([0,0])}function i(b){var a=d[b]||(d[b]={namespace:b,connected:!1,users:h[b]={},user_count:1,get_user_list:function(){return d[b].users},get_user_count:function(){return d[b].user_count},emit:function(a,c,d){l(a,b,c,0,d)},send:function(a,c){l("message",b,a,0,c)},on:function(a,
f){"string"===typeof a?c.events.bind(b+a,f):"object"===typeof a&&c.each(a,function(a){c.events.bind(b+a,f)})},disconnect:function(){c.unsubscribe({channel:a.channel})},history:function(a,f){var d=i(b);a.channel=d.channel;c.detailedHistory(a,function(a){var c=[];PUBNUB.each(a[0]||[],function(a){"message"==a.name&&a.ns==b&&c.push(a)});a[0]=c;f(a)})},here_now:function(a){var d=i(b);c.here_now({channel:d.channel},a)}});return a}var c=PUBNUB,r=0,m=PUBNUB.db.get("uuid")||c.uuid(function(c){PUBNUB.db.set("uuid",
m=c)}),d={},h={},s=window.io={connected:{},connect:function(b,a){function e(){var a=c.map(d,function(a){return a});l("ping",j,{nss:a,cuser:n})}var f=(b+"////").split("/"),a=a||{},n=a.user||{},k="presence"in a?a.presence:!0,t=f[2],j=(f[3]||"standard")+"-"+a.channel,f=a.channel,g=i(j);g.channel=f;g.password="sjcl"in window&&a.password;if(f in s.connected)return g;a.geo&&setInterval(q,15E3)&&q();a.uuid=m;a.origin=t;c=s.connected[f]=r?c:PUBNUB.init(a);r=1;g.disconnected=0;c.subscribe({channel:f,disconnect:function(){g.disconnected||
(g.disconnected=1,c.each(d,function(a){c.events.fire(a+"disconnect",{})}))},reconnect:function(){c.disconnected=0},connect:function(){g.disconnected=0;c.each(d,function(a){i(a).connected||(i(a).connected=!0,c.events.fire(a+"connect",{}))});e()},presence:k&&function(a){"leave"===a.action&&p(a.uuid);"timeout"===a.action&&p(a.uuid);"join"===a.action&&e()},callback:function(a){g.disconnected&&c.each(d,function(a){c.events.fire(a+"reconnect",{})});g.disconnected=0;var b;var e=a.data,f=i(a.ns);if(f.password)try{b=
JSON.parse(sjcl.decrypt(f.password,e))}catch(j){b=null}else b=e;a.ns in d&&b&&c.events.fire(a.ns+a.name,b);a.uuid&&a.uuid!==m&&"ping"===a.name&&c.each(b.nss,function(d){h[d]=h[d]||{};var e=h[d][a.uuid]=h[d][a.uuid]||{geo:a.geo||[0,0],uuid:a.uuid,last:+new Date,socket:g,namespace:d,connected:!1,slot:g.user_count++};e.last=+new Date;e.data=b.cuser;e.connected||(c.events.fire(d+"join",e),e.connected=!0)})}});k&&(setInterval(e,3E4),e());return g}}})();
