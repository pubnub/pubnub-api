...
public class PubnubExample implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		//rootPanel.setSize("750px", "363px");
		//tabPanel.setSize("800px", "363px");
		...
		final ExamplePanel panelPresence = new ExamplePanel(new HTML("", true));
		...
		//tabPanel.add(panelPresence, "Presence", false);
			...
			public void onClick(ClickEvent event) {
				...
				if (startstr.length() != 0) {
					try {
						...
						alert("Start time should be long");
						return;
					}
				}
				if (endstr.length() != 0) {
