    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == form) {//GEN-BEGIN:|7-commandAction|1|19-preAction
            if (command == exitCommand) {//GEN-END:|7-commandAction|1|19-preAction
                ...
                // write post-action user code here
            } else if (command == historyCommand) {//GEN-LINE:|7-commandAction|3|30-preAction
                History();
//GEN-LINE:|7-commandAction|4|30-postAction
                // write post-action user code here
            } else if (command == publishCommand) {//GEN-LINE:|7-commandAction|5|23-preAction
                Publish();
//GEN-LINE:|7-commandAction|6|23-postAction
                // write post-action user code here
            } else if (command == subcribeCommand) {//GEN-LINE:|7-commandAction|7|26-preAction
                Subcribe();
//GEN-LINE:|7-commandAction|8|26-postAction
                // write post-action user code here
            } else if (command == timeCommand) {//GEN-LINE:|7-commandAction|9|28-preAction
                Time();
//GEN-LINE:|7-commandAction|10|28-postAction
                // write post-action user code here
            } else if (command == unsubcribeCommand) {//GEN-LINE:|7-commandAction|11|33-preAction
              UnSubcribe();
//GEN-LINE:|7-commandAction|12|33-postAction
    ...
    public StringItem getStringItem() {
        if (stringItem == null) {//GEN-END:|16-getter|0|16-preInit
            // write pre-init user code here
            stringItem = new StringItem("Hello", "Hello, World!", Item.PLAIN);//GEN-LINE:|16-getter|1|16-postInit
            // write post-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: publishCommand ">//GEN-BEGIN:|22-getter|0|22-preInit
    /**
     * Returns an initiliazed instance of publishCommand component.
     * @return the initialized component instance
     */
    public Command getPublishCommand() {
        if (publishCommand == null) {//GEN-END:|22-getter|0|22-preInit
            // write pre-init user code here
            publishCommand = new Command("Publish", "<null>", Command.SCREEN, 1);//GEN-LINE:|22-getter|1|22-postInit
            // write post-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: subcribeCommand ">//GEN-BEGIN:|25-getter|0|25-preInit
    /**
     * Returns an initiliazed instance of subcribeCommand component.
     * @return the initialized component instance
     */
    public Command getSubcribeCommand() {
        if (subcribeCommand == null) {//GEN-END:|25-getter|0|25-preInit
            // write pre-init user code here
            subcribeCommand = new Command("Subcribe", Command.ITEM, 0);//GEN-LINE:|25-getter|1|25-postInit
            // write post-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: timeCommand ">//GEN-BEGIN:|27-getter|0|27-preInit
    /**
     * Returns an initiliazed instance of timeCommand component.
     * @return the initialized component instance
     */
    public Command getTimeCommand() {
        if (timeCommand == null) {//GEN-END:|27-getter|0|27-preInit
            // write pre-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: historyCommand ">//GEN-BEGIN:|29-getter|0|29-preInit
    /**
     * Returns an initiliazed instance of historyCommand component.
     * @return the initialized component instance
     */
    public Command getHistoryCommand() {
        if (historyCommand == null) {//GEN-END:|29-getter|0|29-preInit
            // write pre-init user code here
            historyCommand = new Command("History", Command.ITEM, 0);//GEN-LINE:|29-getter|1|29-postInit
            // write post-init user code here
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: unsubcribeCommand ">//GEN-BEGIN:|32-getter|0|32-preInit
    /**
     * Returns an initiliazed instance of unsubcribeCommand component.
     * @return the initialized component instance
     */
    public Command getUnsubcribeCommand() {
        if (unsubcribeCommand == null) {//GEN-END:|32-getter|0|32-preInit
            // write pre-init user code here
            unsubcribeCommand = new Command("Unsubcribe", Command.ITEM, 0);//GEN-LINE:|32-getter|1|32-postInit
            // write post-init user code here
